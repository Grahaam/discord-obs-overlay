export const locales = {
  fr: {
    ...
    filter: {
      ...
      banUser: "Bannir temporairement",
      unbanUser: "Débannir",
      banDuration10m: "10 min",
      banDuration1h: "1 heure",
      banDuration24h: "24 heures",
      banDuration7d: "7 jours",
      banDurationCustom: "Personnalisé",
      banDurationCustomPh: "Minutes",
      bannedUsersTitle: "Utilisateurs bannis temporairement",
      bannedUsersEmpty: "Aucun utilisateur banni pour l'instant.",
      bannedUntil: "restant",
    },
    logs: {
    ...
    dock: {
      ...
      noErrors: "Aucune erreur serveur",
      nowPlaying: "En cours",
      queue: "File d'attente",
      queueEmpty: "File vide",
      skip: "Passer l'alerte",
    ...
    favorites: {
      title: "Favoris",
      empty: "Aucun favori. Cliquez sur l'étoile d'une alerte pour l'ajouter.",
      replay: "Rejouer",
      remove: "Retirer",
    },
  },
  en: {
    ...
    filter: {
      ...
      banDurationCustom: "Custom",
      banDurationCustomPh: "Minutes",
      bannedUsersTitle: "Temp-Banned Users",
      bannedUsersEmpty: "No users currently banned.",
    ...
    favorites: {
      title: "Favorites",
      empty: "No favorites yet. Click the star on an alert to add it.",
      replay: "Replay",
      remove: "Remove",
    },
  },
  "uwu-en": {
    ...
    filter: {
      ...
      banUser: "Tempowawy ban UwU",
      unbanUser: "Unban~",
      banDuration10m: "10 min",
      banDuration1h: "1 houw",
      banDuration24h: "24 houws",
      banDuration7d: "7 days",
      banDurationCustom: "Custom~",
      banDurationCustomPh: "Minutes",
      bannedUsersTitle: "Tempowawiwy Banned Usews o_o",
      bannedUsersEmpty: "No one is banned wight now~",
      bannedUntil: "wemaining",
    },
    logs: {
      title: "Activities & Wogs o_o",
      logsSub: "Twace of aww media awewts weceived.",
      clear: "Cweaw Histowy UwU",
      replayLast: "Wepway Wast~",
      ...
      replay: "Wepway UwU",
      favorite: "Add to favowites~",
      unfavorite: "Wemove fwom favowites",
      simTypeAuto: "Image / Auto",
    ...
    dock: {
      ...
      paused: "PAUSED OwO",
      activity: "Activitwy",
      system: "Sewvew Ewwows",
      noActivity: "No activitwy yet~",
      noErrors: "No sewvew ewwows UwU",
      nowPlaying: "Nyow Pwaying",
      queue: "Queue UwU",
      queueEmpty: "Queue empty :3",
      skip: "Skip awewt",
      clearQueue: "Cweaw queue",
      volume: "Vowume",
      seek: "Seek~",
      reconnect: "Weconnect Bawt",
      andMore: "+{n} mowe~",
    ...
    favorites: {
      title: "Favowites~",
      empty: "No favowites yet~ Cwick da staw on an awewt to add it uwu.",
      replay: "Wepway UwU",
      remove: "Wemove",
    },
  },
  "uwu-fr": {
    ...
    filter: {
      ...
      banUser: "Bannissement tempowaiwe",
      unbanUser: "Débannir~",
      banDuration10m: "10 min",
      banDuration1h: "1 heuwe",
      banDuration24h: "24 heuwes",
      banDuration7d: "7 jouws",
      banDurationCustom: "Pewsonnawisé",
      banDurationCustomPh: "Minutes",
      bannedUsersTitle: "Utiwisateuws bannis tempowaiwement",
      bannedUsersEmpty: "Peuwsonne n'est banni pouw w'instant~",
      bannedUntil: "westant",
    },
    logs: {
      ...
      replay: "Wejouer UwU",
      favorite: "Ajoutew aux favowis~",
      unfavorite: "Wetiwew des favowis",
      simTypeAuto: "Image / Auto",
    ...
    dock: {
      ...
      resume: "Wepwendre~",
      paused: "EN PAUSE OwO",
      activity: "Activité UwU",
      system: "Ewweurs Système",
      noActivity: "Aucune activitée~",
      noErrors: "Aucune ewweur sewveur UwU",
      nowPlaying: "En cours~",
      queue: "File d'attente UwU",
      queueEmpty: "File vide :3",
      skip: "Passew l'awewte",
      clearQueue: "Videw la file",
      volume: "Vowume",
      seek: "Seek~",
      reconnect: "Weconnect Bawt",
    ...
    favorites: {
      title: "Favowis~",
      empty: "Aucun favowi~ Cwiquez suw w'étoiwe d'une awewte pouw w'ajoutew.",
      replay: "Wejouer UwU",
      remove: "Wetiwew",
    },
  },
